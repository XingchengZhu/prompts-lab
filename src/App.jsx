...
import { Search, Plus, Trash2, Copy, Check, Command, Github, Sparkles } from 'lucide-react';
...
function App() {
  ...
  if (prompts.length === 0) {
    return (
      <div className="h-screen flex flex-col items-center justify-center gap-4 bg-zinc-950 text-zinc-200">
        <div className="p-4 bg-zinc-900 rounded-full"><Sparkles size={32} className="text-indigo-500"/></div>
